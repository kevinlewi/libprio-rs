...
pub trait Vdaf: Clone + Debug {
    ...
    /// shares.
    type AggregationParam: Clone + Debug + Decode<(), Error = VdafError> + Encode;
    ...
    type InputShare: Clone + Debug + Decode<Self::VerifyParam, Error = VdafError> + Encode;
...
pub trait Aggregator: Vdaf {
    ...
    type PrepareMessage: Clone + Debug + Decode<Self::PrepareStep, Error = VdafError> + Encode;
